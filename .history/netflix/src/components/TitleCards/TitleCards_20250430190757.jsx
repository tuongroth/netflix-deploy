...
const TitleCards = ({ title }) => {
  const [apiData, setApiData] = useState([
    ...
    },
    {
      id: 1233414,
      original_language: 'en',
      original_title: 'The Mystery',
      overview: 'A gripping psychological thriller that follows a detective trying to uncover the truth behind a string of mysterious disappearances.',
      popularity: 210.5462,
      poster_path: '/eSHyB2kmhE0eLgXUeyFZPQyVp2O.jpg',
