...
import { createUserWithEmailAndPassword, getAuth, signInWithCustomToken } from "firebase/auth/web-extension";
...
const login = async (email, password)=>{try{signInWithCustomToken}catch(error){}}